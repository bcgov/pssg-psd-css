...
namespace Gov.Jag.Pssg.Csa.Interfaces.Models
{
    ...
    public partial class MicrosoftDynamicsCRMemail
    {
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "regardingobjectid_csu_complaints_email")]
        public MicrosoftDynamicsCRMcsuComplaints RegardingobjectidCsuComplaintsEmail { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "regardingobjectid_csu_subjectofcomplaint_email")]
        public MicrosoftDynamicsCRMcsuSubjectofcomplaint RegardingobjectidCsuSubjectofcomplaintEmail { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "regardingobjectid_csu_vehicledetail_email")]
        public MicrosoftDynamicsCRMcsuVehicledetail RegardingobjectidCsuVehicledetailEmail { get; set; }
