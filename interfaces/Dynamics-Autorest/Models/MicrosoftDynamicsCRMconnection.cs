...
namespace Gov.Jag.Pssg.Csa.Interfaces.Models
{
    ...
    public partial class MicrosoftDynamicsCRMconnection
    {
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "record1id_csu_casetask")]
        public MicrosoftDynamicsCRMcsuCasetask Record1idCsuCasetask { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "record2id_csu_casetask")]
        public MicrosoftDynamicsCRMcsuCasetask Record2idCsuCasetask { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "record1id_csu_vehicledetail")]
        public MicrosoftDynamicsCRMcsuVehicledetail Record1idCsuVehicledetail { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "record2id_csu_vehicledetail")]
        public MicrosoftDynamicsCRMcsuVehicledetail Record2idCsuVehicledetail { get; set; }
