...
namespace Gov.Jag.Pssg.Csa.Interfaces.Models
{
    ...
    public partial class MicrosoftDynamicsCRMserviceappointment
    {
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "regardingobjectid_csu_complaints_serviceappointment")]
        public MicrosoftDynamicsCRMcsuComplaints RegardingobjectidCsuComplaintsServiceappointment { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "regardingobjectid_csu_subjectofcomplaint_serviceappointment")]
        public MicrosoftDynamicsCRMcsuSubjectofcomplaint RegardingobjectidCsuSubjectofcomplaintServiceappointment { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "regardingobjectid_csu_vehicledetail_serviceappointment")]
        public MicrosoftDynamicsCRMcsuVehicledetail RegardingobjectidCsuVehicledetailServiceappointment { get; set; }
