...
namespace Gov.Jag.Pssg.Csa.Interfaces.Models
{
    ...
    public partial class MicrosoftDynamicsCRMphonecall
    {
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "regardingobjectid_csu_complaints_phonecall")]
        public MicrosoftDynamicsCRMcsuComplaints RegardingobjectidCsuComplaintsPhonecall { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "regardingobjectid_csu_subjectofcomplaint_phonecall")]
        public MicrosoftDynamicsCRMcsuSubjectofcomplaint RegardingobjectidCsuSubjectofcomplaintPhonecall { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "regardingobjectid_csu_vehicledetail_phonecall")]
        public MicrosoftDynamicsCRMcsuVehicledetail RegardingobjectidCsuVehicledetailPhonecall { get; set; }
