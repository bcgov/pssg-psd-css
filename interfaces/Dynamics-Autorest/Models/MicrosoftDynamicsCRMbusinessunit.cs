...
namespace Gov.Jag.Pssg.Csa.Interfaces.Models
{
    ...
    public partial class MicrosoftDynamicsCRMbusinessunit
    {
        ...
        public MicrosoftDynamicsCRMbusinessunit(System.Guid? address1Addressid = default(System.Guid?), string address2Line2 = default(string), bool? workflowsuspended = default(bool?), string address2Upszone = default(string), string address2Stateorprovince = default(string), System.DateTimeOffset? createdon = default(System.DateTimeOffset?), string address1Telephone2 = default(string), string picture = default(string), string divisionname = default(string), string tickersymbol = default(string), string address1Line3 = default(string), string disabledreason = default(string), int? address2Shippingmethodcode = default(int?), int? address1Shippingmethodcode = default(int?), string fileasname = default(string), string address2Name = default(string), int? address2Utcoffset = default(int?), string stockexchange = default(string), string address2Fax = default(string), string address2Line3 = default(string), System.Guid? _createdonbehalfbyValue = default(System.Guid?), System.Guid? businessunitid = default(System.Guid?), string description = default(string), string address1City = default(string), string address1Name = default(string), string address2Postofficebox = default(string), System.Guid? address2Addressid = default(System.Guid?), System.Guid? _calendaridValue = default(System.Guid?), string address2Telephone2 = default(string), string address2Postalcode = default(string), System.Guid? _createdbyValue = default(System.Guid?), int? importsequencenumber = default(int?), System.Guid? _modifiedbyValue = default(System.Guid?), System.DateTimeOffset? modifiedon = default(System.DateTimeOffset?), System.Guid? _transactioncurrencyidValue = default(System.Guid?), System.Guid? _organizationidValue = default(System.Guid?), string address2Latitude = default(string), string creditlimit = default(string), string address1County = default(string), System.Guid? _modifiedonbehalfbyValue = default(System.Guid?), string address1Longitude = default(string), string emailaddress = default(string), string name = default(string), string address1Postalcode = default(string), string ftpsiteurl = default(string), string address1Fax = default(string), string address2Line1 = default(string), int? address2Addresstypecode = default(int?), string versionnumber = default(string), int? utcoffset = default(int?), string costcenter = default(string), string address1Postofficebox = default(string), string address1Line2 = default(string), string address2Longitude = default(string), string address1Upszone = default(string), string address2County = default(string), string address2City = default(string), string address1Country = default(string), int? address1Utcoffset = default(int?), string address1Stateorprovince = default(string), string address1Telephone3 = default(string), int? address1Addresstypecode = default(int?), string address1Line1 = default(string), System.Guid? _parentbusinessunitidValue = default(System.Guid?), string address1Telephone1 = default(string), string address2Country = default(string), string address2Telephone3 = default(string), bool? isdisabled = default(bool?), string address1Latitude = default(string), System.DateTimeOffset? overriddencreatedon = default(System.DateTimeOffset?), int? inheritancemask = default(int?), string address2Telephone1 = default(string), string websiteurl = default(string), decimal? exchangerate = default(decimal?), IList<MicrosoftDynamicsCRMexchangesyncidmapping> businessUnitExchangesyncidmapping = default(IList<MicrosoftDynamicsCRMexchangesyncidmapping>), IList<MicrosoftDynamicsCRMinteractionforemail> businessUnitNewInteractionforemail = default(IList<MicrosoftDynamicsCRMinteractionforemail>), IList<MicrosoftDynamicsCRMknowledgearticle> businessUnitKnowledgearticle = default(IList<MicrosoftDynamicsCRMknowledgearticle>), IList<MicrosoftDynamicsCRMsharepointdocumentlocation> businessUnitSharepointdocumentlocation = default(IList<MicrosoftDynamicsCRMsharepointdocumentlocation>), IList<MicrosoftDynamicsCRMgoal> businessUnitGoal = default(IList<MicrosoftDynamicsCRMgoal>), IList<MicrosoftDynamicsCRMmailbox> businessUnitMailbox = default(IList<MicrosoftDynamicsCRMmailbox>), IList<MicrosoftDynamicsCRMrecurrencerule> businessUnitRecurrencerule = default(IList<MicrosoftDynamicsCRMrecurrencerule>), IList<MicrosoftDynamicsCRMlead> businessUnitLeads = default(IList<MicrosoftDynamicsCRMlead>), IList<MicrosoftDynamicsCRMdynamicpropertyinstance> businessUnitDynamicproperyinstance = default(IList<MicrosoftDynamicsCRMdynamicpropertyinstance>), IList<MicrosoftDynamicsCRMbookableresource> businessUnitBookableresource = default(IList<MicrosoftDynamicsCRMbookableresource>), IList<MicrosoftDynamicsCRMbookableresourcebooking> businessUnitBookableresourcebooking = default(IList<MicrosoftDynamicsCRMbookableresourcebooking>), IList<MicrosoftDynamicsCRMbookableresourcebookingheader> businessUnitBookableresourcebookingheader = default(IList<MicrosoftDynamicsCRMbookableresourcebookingheader>), IList<MicrosoftDynamicsCRMbookableresourcecategory> businessUnitBookableresourcecategory = default(IList<MicrosoftDynamicsCRMbookableresourcecategory>), IList<MicrosoftDynamicsCRMbookableresourcecategoryassn> businessUnitBookableresourcecategoryassn = default(IList<MicrosoftDynamicsCRMbookableresourcecategoryassn>), IList<MicrosoftDynamicsCRMbookableresourcecharacteristic> businessUnitBookableresourcecharacteristic = default(IList<MicrosoftDynamicsCRMbookableresourcecharacteristic>), IList<MicrosoftDynamicsCRMbookableresourcegroup> businessUnitBookableresourcegroup = default(IList<MicrosoftDynamicsCRMbookableresourcegroup>), IList<MicrosoftDynamicsCRMbookingstatus> businessUnitBookingstatus = default(IList<MicrosoftDynamicsCRMbookingstatus>), IList<MicrosoftDynamicsCRMcharacteristic> businessUnitCharacteristic = default(IList<MicrosoftDynamicsCRMcharacteristic>), IList<MicrosoftDynamicsCRMratingmodel> businessUnitRatingmodel = default(IList<MicrosoftDynamicsCRMratingmodel>), IList<MicrosoftDynamicsCRMratingvalue> businessUnitRatingvalue = default(IList<MicrosoftDynamicsCRMratingvalue>), IList<MicrosoftDynamicsCRMbulkoperation> businessUnitBulkOperationActivities = default(IList<MicrosoftDynamicsCRMbulkoperation>), IList<MicrosoftDynamicsCRMcampaign> businessUnitCampaigns = default(IList<MicrosoftDynamicsCRMcampaign>), IList<MicrosoftDynamicsCRMcampaignactivity> businessUnitCampaignactivityActivities = default(IList<MicrosoftDynamicsCRMcampaignactivity>), IList<MicrosoftDynamicsCRMcampaignresponse> businessUnitCampaignresponseActivities = default(IList<MicrosoftDynamicsCRMcampaignresponse>), IList<MicrosoftDynamicsCRMlist> businessUnitList = default(IList<MicrosoftDynamicsCRMlist>), IList<MicrosoftDynamicsCRMconstraintbasedgroup> businessUnitConstraintBasedGroups = default(IList<MicrosoftDynamicsCRMconstraintbasedgroup>), IList<MicrosoftDynamicsCRMcontract> businessUnitServiceContracts = default(IList<MicrosoftDynamicsCRMcontract>), IList<MicrosoftDynamicsCRMentitlement> businessUnitEntitlement = default(IList<MicrosoftDynamicsCRMentitlement>), IList<MicrosoftDynamicsCRMequipment> businessUnitEquipment = default(IList<MicrosoftDynamicsCRMequipment>), IList<MicrosoftDynamicsCRMincident> businessUnitIncidents = default(IList<MicrosoftDynamicsCRMincident>), IList<MicrosoftDynamicsCRMincidentresolution> businessUnitIncidentResolutionActivities = default(IList<MicrosoftDynamicsCRMincidentresolution>), IList<MicrosoftDynamicsCRMresource> businessUnitResources = default(IList<MicrosoftDynamicsCRMresource>), IList<MicrosoftDynamicsCRMresourcegroup> businessUnitResourceGroups = default(IList<MicrosoftDynamicsCRMresourcegroup>), IList<MicrosoftDynamicsCRMresourcespec> businessUnitResourceSpecs = default(IList<MicrosoftDynamicsCRMresourcespec>), IList<MicrosoftDynamicsCRMserviceappointment> businessUnitServiceAppointments = default(IList<MicrosoftDynamicsCRMserviceappointment>), IList<MicrosoftDynamicsCRMinvoice> businessUnitInvoices = default(IList<MicrosoftDynamicsCRMinvoice>), IList<MicrosoftDynamicsCRMopportunity> businessUnitOpportunities = default(IList<MicrosoftDynamicsCRMopportunity>), IList<MicrosoftDynamicsCRMopportunityclose> businessUnitOpportunityCloseActivities = default(IList<MicrosoftDynamicsCRMopportunityclose>), IList<MicrosoftDynamicsCRMorderclose> businessUnitOrderCloseActivities = default(IList<MicrosoftDynamicsCRMorderclose>), IList<MicrosoftDynamicsCRMquote> businessUnitQuotes = default(IList<MicrosoftDynamicsCRMquote>), IList<MicrosoftDynamicsCRMquoteclose> businessUnitQuoteCloseActivities = default(IList<MicrosoftDynamicsCRMquoteclose>), IList<MicrosoftDynamicsCRMsalesorder> businessUnitOrders = default(IList<MicrosoftDynamicsCRMsalesorder>), IList<MicrosoftDynamicsCRMmsdynRelationshipinsightsunifiedconfig> businessUnitMsdynRelationshipinsightsunifiedconfig = default(IList<MicrosoftDynamicsCRMmsdynRelationshipinsightsunifiedconfig>), IList<MicrosoftDynamicsCRMmsdynSiconfig> businessUnitMsdynSiconfig = default(IList<MicrosoftDynamicsCRMmsdynSiconfig>), IList<MicrosoftDynamicsCRMmsdynPostalbum> businessUnitMsdynPostalbum = default(IList<MicrosoftDynamicsCRMmsdynPostalbum>), IList<MicrosoftDynamicsCRMmsdynWallsavedqueryusersettings> businessUnitMsdynWallsavedqueryusersettings = default(IList<MicrosoftDynamicsCRMmsdynWallsavedqueryusersettings>), IList<MicrosoftDynamicsCRMcsuComplaints> businessUnitCsuComplaints = default(IList<MicrosoftDynamicsCRMcsuComplaints>), IList<MicrosoftDynamicsCRMcsuSeizuredetails> businessUnitCsuSeizuredetails = default(IList<MicrosoftDynamicsCRMcsuSeizuredetails>), IList<MicrosoftDynamicsCRMcsuSubjectofcomplaint> businessUnitCsuSubjectofcomplaint = default(IList<MicrosoftDynamicsCRMcsuSubjectofcomplaint>), IList<MicrosoftDynamicsCRMcsuCasepersondetails> businessUnitCsuCasepersondetails = default(IList<MicrosoftDynamicsCRMcsuCasepersondetails>), IList<MicrosoftDynamicsCRMcsuCasebusinessandlocationdetails> businessUnitCsuCasebusinessandlocationdetails = default(IList<MicrosoftDynamicsCRMcsuCasebusinessandlocationdetails>), IList<MicrosoftDynamicsCRMcsuCasetask> csuCasetaskBusinessunitOwningbusinessunit = default(IList<MicrosoftDynamicsCRMcsuCasetask>), IList<MicrosoftDynamicsCRMcsuInspectionsearch> businessUnitCsuInspectionsearch = default(IList<MicrosoftDynamicsCRMcsuInspectionsearch>), IList<MicrosoftDynamicsCRMcsuViolation> businessUnitCsuViolation = default(IList<MicrosoftDynamicsCRMcsuViolation>), IList<MicrosoftDynamicsCRMcsuOffence> businessUnitCsuOffence = default(IList<MicrosoftDynamicsCRMcsuOffence>), IList<MicrosoftDynamicsCRMcsuAmp> businessUnitCsuAmp = default(IList<MicrosoftDynamicsCRMcsuAmp>), IList<MicrosoftDynamicsCRMcsuDemandandorder> businessUnitCsuDemandandorder = default(IList<MicrosoftDynamicsCRMcsuDemandandorder>), IList<MicrosoftDynamicsCRMcsuHearing> businessUnitCsuHearing = default(IList<MicrosoftDynamicsCRMcsuHearing>), IList<MicrosoftDynamicsCRMcsuPayment> businessUnitCsuPayment = default(IList<MicrosoftDynamicsCRMcsuPayment>), IList<MicrosoftDynamicsCRMcsuAmporder> businessUnitCsuAmporder = default(IList<MicrosoftDynamicsCRMcsuAmporder>), IList<MicrosoftDynamicsCRMcsuInjuctiondetail> businessUnitCsuInjuctiondetail = default(IList<MicrosoftDynamicsCRMcsuInjuctiondetail>), IList<MicrosoftDynamicsCRMcsuAmporderreminders> businessUnitCsuAmporderreminders = default(IList<MicrosoftDynamicsCRMcsuAmporderreminders>), IList<MicrosoftDynamicsCRMcsuApplicationforreturnofseizedcannabis> businessUnitCsuApplicationforreturnofseizedcannabis = default(IList<MicrosoftDynamicsCRMcsuApplicationforreturnofseizedcannabis>), IList<MicrosoftDynamicsCRMcsuSeizeditemsrequestedforreturn> businessUnitCsuSeizeditemsrequestedforreturn = default(IList<MicrosoftDynamicsCRMcsuSeizeditemsrequestedforreturn>), IList<MicrosoftDynamicsCRMcsuJudicialreview> businessUnitCsuJudicialreview = default(IList<MicrosoftDynamicsCRMcsuJudicialreview>), IList<MicrosoftDynamicsCRMcsuCourtdate> businessUnitCsuCourtdate = default(IList<MicrosoftDynamicsCRMcsuCourtdate>), IList<MicrosoftDynamicsCRMcsuPhonehistory> businessUnitCsuPhonehistory = default(IList<MicrosoftDynamicsCRMcsuPhonehistory>), IList<MicrosoftDynamicsCRMcsuAddresshistory> businessUnitCsuAddresshistory = default(IList<MicrosoftDynamicsCRMcsuAddresshistory>), IList<MicrosoftDynamicsCRMcsuVehicledetail> businessUnitCsuVehicledetail = default(IList<MicrosoftDynamicsCRMcsuVehicledetail>), IList<MicrosoftDynamicsCRMcsuCasevehicledetail> businessUnitCsuCasevehicledetail = default(IList<MicrosoftDynamicsCRMcsuCasevehicledetail>), IList<MicrosoftDynamicsCRMcsuComplaintseizure> businessUnitCsuComplaintseizure = default(IList<MicrosoftDynamicsCRMcsuComplaintseizure>), IList<MicrosoftDynamicsCRMcsuCsaactivity> businessUnitCsuCsaactivity = default(IList<MicrosoftDynamicsCRMcsuCsaactivity>), IList<MicrosoftDynamicsCRMcsuCsaspecifiedactivity> businessUnitCsuCsaspecifiedactivity = default(IList<MicrosoftDynamicsCRMcsuCsaspecifiedactivity>), IList<MicrosoftDynamicsCRMsyncerror> businessUnitSyncErrors = default(IList<MicrosoftDynamicsCRMsyncerror>), MicrosoftDynamicsCRMtransactioncurrency transactioncurrencyid = default(MicrosoftDynamicsCRMtransactioncurrency), IList<MicrosoftDynamicsCRMbulkdeleteoperation> bulkDeleteOperationBusinessUnit = default(IList<MicrosoftDynamicsCRMbulkdeleteoperation>), MicrosoftDynamicsCRMsystemuser modifiedby = default(MicrosoftDynamicsCRMsystemuser), IList<MicrosoftDynamicsCRMworkflow> businessUnitWorkflow = default(IList<MicrosoftDynamicsCRMworkflow>), IList<MicrosoftDynamicsCRMsyncerror> businessUnitSyncError = default(IList<MicrosoftDynamicsCRMsyncerror>), IList<MicrosoftDynamicsCRMpostregarding> businessUnitPostRegarding = default(IList<MicrosoftDynamicsCRMpostregarding>), IList<MicrosoftDynamicsCRMpostfollow> businessUnitPostfollows = default(IList<MicrosoftDynamicsCRMpostfollow>), IList<MicrosoftDynamicsCRMasyncoperation> businessUnitAsyncOperations = default(IList<MicrosoftDynamicsCRMasyncoperation>), IList<MicrosoftDynamicsCRMqueue> businessUnitQueues = default(IList<MicrosoftDynamicsCRMqueue>), IList<MicrosoftDynamicsCRMfax> businessUnitFaxActivities = default(IList<MicrosoftDynamicsCRMfax>), IList<MicrosoftDynamicsCRMcalendar> businessUnitCalendars = default(IList<MicrosoftDynamicsCRMcalendar>), MicrosoftDynamicsCRMsystemuser createdonbehalfby = default(MicrosoftDynamicsCRMsystemuser), IList<MicrosoftDynamicsCRMimportlog> businessUnitImportLogs = default(IList<MicrosoftDynamicsCRMimportlog>), IList<MicrosoftDynamicsCRMannotation> businessUnitAnnotations = default(IList<MicrosoftDynamicsCRMannotation>), MicrosoftDynamicsCRMcalendar calendarid = default(MicrosoftDynamicsCRMcalendar), IList<MicrosoftDynamicsCRMrecurringappointmentmaster> businessUnitRecurringappointmentmasterActivities = default(IList<MicrosoftDynamicsCRMrecurringappointmentmaster>), IList<MicrosoftDynamicsCRMtemplate> businessUnitTemplates = default(IList<MicrosoftDynamicsCRMtemplate>), IList<MicrosoftDynamicsCRMaccount> businessUnitAccounts = default(IList<MicrosoftDynamicsCRMaccount>), IList<MicrosoftDynamicsCRMsocialprofile> businessUnitSocialprofiles = default(IList<MicrosoftDynamicsCRMsocialprofile>), IList<MicrosoftDynamicsCRMappointment> businessUnitAppointmentActivities = default(IList<MicrosoftDynamicsCRMappointment>), IList<MicrosoftDynamicsCRMletter> businessUnitLetterActivities = default(IList<MicrosoftDynamicsCRMletter>), IList<MicrosoftDynamicsCRMactioncard> businessUnitActioncards = default(IList<MicrosoftDynamicsCRMactioncard>), IList<MicrosoftDynamicsCRMtask> businessUnitTaskActivities = default(IList<MicrosoftDynamicsCRMtask>), IList<MicrosoftDynamicsCRMactivitypointer> businessUnitActivitypointer = default(IList<MicrosoftDynamicsCRMactivitypointer>), IList<MicrosoftDynamicsCRMqueue> businessUnitQueues2 = default(IList<MicrosoftDynamicsCRMqueue>), IList<MicrosoftDynamicsCRMasyncoperation> businessUnitAsyncoperation = default(IList<MicrosoftDynamicsCRMasyncoperation>), IList<MicrosoftDynamicsCRMemail> businessUnitEmailActivities = default(IList<MicrosoftDynamicsCRMemail>), IList<MicrosoftDynamicsCRMrole> businessUnitRoles = default(IList<MicrosoftDynamicsCRMrole>), IList<MicrosoftDynamicsCRMteam> businessUnitTeams = default(IList<MicrosoftDynamicsCRMteam>), MicrosoftDynamicsCRMsystemuser createdby = default(MicrosoftDynamicsCRMsystemuser), IList<MicrosoftDynamicsCRMuserqueryvisualization> businessUnitUserqueryvisualizations = default(IList<MicrosoftDynamicsCRMuserqueryvisualization>), IList<MicrosoftDynamicsCRMslakpiinstance> businessUnitSlakpiinstance = default(IList<MicrosoftDynamicsCRMslakpiinstance>), IList<MicrosoftDynamicsCRMprocesssession> owningBusinessunitProcesssessions = default(IList<MicrosoftDynamicsCRMprocesssession>), IList<MicrosoftDynamicsCRMduplicaterule> businessUnitDuplicateRules = default(IList<MicrosoftDynamicsCRMduplicaterule>), MicrosoftDynamicsCRMsystemuser modifiedonbehalfby = default(MicrosoftDynamicsCRMsystemuser), IList<MicrosoftDynamicsCRMimportdata> businessUnitImportData = default(IList<MicrosoftDynamicsCRMimportdata>), IList<MicrosoftDynamicsCRMprocesssession> businessUnitProcessSessions = default(IList<MicrosoftDynamicsCRMprocesssession>), MicrosoftDynamicsCRMorganization organizationid = default(MicrosoftDynamicsCRMorganization), IList<MicrosoftDynamicsCRMphonecall> businessUnitPhoneCallActivities = default(IList<MicrosoftDynamicsCRMphonecall>), IList<MicrosoftDynamicsCRMcontact> businessUnitContacts = default(IList<MicrosoftDynamicsCRMcontact>), IList<MicrosoftDynamicsCRMsharepointsite> businessUnitSharepointsites = default(IList<MicrosoftDynamicsCRMsharepointsite>), IList<MicrosoftDynamicsCRMemailserverprofile> businessUnitEmailserverprofile = default(IList<MicrosoftDynamicsCRMemailserverprofile>), IList<MicrosoftDynamicsCRMmailmergetemplate> businessUnitMailmergetemplates = default(IList<MicrosoftDynamicsCRMmailmergetemplate>), IList<MicrosoftDynamicsCRMworkflowlog> businessUnitWorkflowlogs = default(IList<MicrosoftDynamicsCRMworkflowlog>), IList<MicrosoftDynamicsCRMbulkdeletefailure> businessUnitBulkDeleteFailures = default(IList<MicrosoftDynamicsCRMbulkdeletefailure>), IList<MicrosoftDynamicsCRMconnection> businessUnitConnections = default(IList<MicrosoftDynamicsCRMconnection>), IList<MicrosoftDynamicsCRMpersonaldocumenttemplate> businessUnitPersonaldocumenttemplates = default(IList<MicrosoftDynamicsCRMpersonaldocumenttemplate>), IList<MicrosoftDynamicsCRMimportfile> businessUnitImportFiles = default(IList<MicrosoftDynamicsCRMimportfile>), IList<MicrosoftDynamicsCRMfeedback> businessUnitFeedback = default(IList<MicrosoftDynamicsCRMfeedback>), IList<MicrosoftDynamicsCRMreport> businessUnitReports = default(IList<MicrosoftDynamicsCRMreport>), IList<MicrosoftDynamicsCRMmailboxtrackingfolder> businessunitMailboxtrackingfolder = default(IList<MicrosoftDynamicsCRMmailboxtrackingfolder>), IList<MicrosoftDynamicsCRMprincipalobjectattributeaccess> businessunitPrincipalobjectattributeaccess = default(IList<MicrosoftDynamicsCRMprincipalobjectattributeaccess>), IList<MicrosoftDynamicsCRMusersettings> businessUnitUserSettings = default(IList<MicrosoftDynamicsCRMusersettings>), IList<MicrosoftDynamicsCRMimport> businessUnitImports = default(IList<MicrosoftDynamicsCRMimport>), IList<MicrosoftDynamicsCRMcategory> businessUnitCategory = default(IList<MicrosoftDynamicsCRMcategory>), IList<MicrosoftDynamicsCRMsystemuser> businessUnitSystemUsers = default(IList<MicrosoftDynamicsCRMsystemuser>), IList<MicrosoftDynamicsCRMsla> businessUnitSlabase = default(IList<MicrosoftDynamicsCRMsla>), IList<MicrosoftDynamicsCRMuserform> businessUnitUserform = default(IList<MicrosoftDynamicsCRMuserform>), IList<MicrosoftDynamicsCRMsocialactivity> businessUnitSocialactivity = default(IList<MicrosoftDynamicsCRMsocialactivity>), IList<MicrosoftDynamicsCRMgoalrollupquery> businessUnitGoalrollupquery = default(IList<MicrosoftDynamicsCRMgoalrollupquery>), IList<MicrosoftDynamicsCRMuserquery> businessUnitUserquery = default(IList<MicrosoftDynamicsCRMuserquery>), IList<MicrosoftDynamicsCRMimportmap> businessUnitImportMaps = default(IList<MicrosoftDynamicsCRMimportmap>), MicrosoftDynamicsCRMbusinessunit parentbusinessunitid = default(MicrosoftDynamicsCRMbusinessunit), IList<MicrosoftDynamicsCRMbusinessunit> businessUnitParentBusinessUnit = default(IList<MicrosoftDynamicsCRMbusinessunit>), IList<MicrosoftDynamicsCRMcsuCaseseizedtypesandamounts> businessUnitCsuCaseseizedtypesandamounts = default(IList<MicrosoftDynamicsCRMcsuCaseseizedtypesandamounts>))
        {
            ...
            BusinessUnitCsuComplaints = businessUnitCsuComplaints;
            BusinessUnitCsuSeizuredetails = businessUnitCsuSeizuredetails;
            BusinessUnitCsuSubjectofcomplaint = businessUnitCsuSubjectofcomplaint;
            BusinessUnitCsuCasepersondetails = businessUnitCsuCasepersondetails;
            BusinessUnitCsuCasebusinessandlocationdetails = businessUnitCsuCasebusinessandlocationdetails;
            CsuCasetaskBusinessunitOwningbusinessunit = csuCasetaskBusinessunitOwningbusinessunit;
            BusinessUnitCsuInspectionsearch = businessUnitCsuInspectionsearch;
            BusinessUnitCsuViolation = businessUnitCsuViolation;
            BusinessUnitCsuOffence = businessUnitCsuOffence;
            BusinessUnitCsuAmp = businessUnitCsuAmp;
            BusinessUnitCsuDemandandorder = businessUnitCsuDemandandorder;
            BusinessUnitCsuHearing = businessUnitCsuHearing;
            BusinessUnitCsuPayment = businessUnitCsuPayment;
            BusinessUnitCsuAmporder = businessUnitCsuAmporder;
            BusinessUnitCsuInjuctiondetail = businessUnitCsuInjuctiondetail;
            BusinessUnitCsuAmporderreminders = businessUnitCsuAmporderreminders;
            BusinessUnitCsuApplicationforreturnofseizedcannabis = businessUnitCsuApplicationforreturnofseizedcannabis;
            BusinessUnitCsuSeizeditemsrequestedforreturn = businessUnitCsuSeizeditemsrequestedforreturn;
            BusinessUnitCsuJudicialreview = businessUnitCsuJudicialreview;
            BusinessUnitCsuCourtdate = businessUnitCsuCourtdate;
            BusinessUnitCsuPhonehistory = businessUnitCsuPhonehistory;
            BusinessUnitCsuAddresshistory = businessUnitCsuAddresshistory;
            BusinessUnitCsuVehicledetail = businessUnitCsuVehicledetail;
            BusinessUnitCsuCasevehicledetail = businessUnitCsuCasevehicledetail;
            BusinessUnitCsuComplaintseizure = businessUnitCsuComplaintseizure;
            BusinessUnitCsuCsaactivity = businessUnitCsuCsaactivity;
            BusinessUnitCsuCsaspecifiedactivity = businessUnitCsuCsaspecifiedactivity;
            ...
            BusinessUnitCsuCaseseizedtypesandamounts = businessUnitCsuCaseseizedtypesandamounts;
            CustomInit();
        }
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "business_unit_csu_complaints")]
        public IList<MicrosoftDynamicsCRMcsuComplaints> BusinessUnitCsuComplaints { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "business_unit_csu_seizuredetails")]
        public IList<MicrosoftDynamicsCRMcsuSeizuredetails> BusinessUnitCsuSeizuredetails { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "business_unit_csu_subjectofcomplaint")]
        public IList<MicrosoftDynamicsCRMcsuSubjectofcomplaint> BusinessUnitCsuSubjectofcomplaint { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "business_unit_csu_casepersondetails")]
        public IList<MicrosoftDynamicsCRMcsuCasepersondetails> BusinessUnitCsuCasepersondetails { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "business_unit_csu_casebusinessandlocationdetails")]
        public IList<MicrosoftDynamicsCRMcsuCasebusinessandlocationdetails> BusinessUnitCsuCasebusinessandlocationdetails { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "csu_casetask_businessunit_owningbusinessunit")]
        public IList<MicrosoftDynamicsCRMcsuCasetask> CsuCasetaskBusinessunitOwningbusinessunit { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "business_unit_csu_inspectionsearch")]
        public IList<MicrosoftDynamicsCRMcsuInspectionsearch> BusinessUnitCsuInspectionsearch { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "business_unit_csu_violation")]
        public IList<MicrosoftDynamicsCRMcsuViolation> BusinessUnitCsuViolation { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "business_unit_csu_offence")]
        public IList<MicrosoftDynamicsCRMcsuOffence> BusinessUnitCsuOffence { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "business_unit_csu_amp")]
        public IList<MicrosoftDynamicsCRMcsuAmp> BusinessUnitCsuAmp { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "business_unit_csu_demandandorder")]
        public IList<MicrosoftDynamicsCRMcsuDemandandorder> BusinessUnitCsuDemandandorder { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "business_unit_csu_hearing")]
        public IList<MicrosoftDynamicsCRMcsuHearing> BusinessUnitCsuHearing { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "business_unit_csu_payment")]
        public IList<MicrosoftDynamicsCRMcsuPayment> BusinessUnitCsuPayment { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "business_unit_csu_amporder")]
        public IList<MicrosoftDynamicsCRMcsuAmporder> BusinessUnitCsuAmporder { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "business_unit_csu_injuctiondetail")]
        public IList<MicrosoftDynamicsCRMcsuInjuctiondetail> BusinessUnitCsuInjuctiondetail { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "business_unit_csu_amporderreminders")]
        public IList<MicrosoftDynamicsCRMcsuAmporderreminders> BusinessUnitCsuAmporderreminders { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "business_unit_csu_applicationforreturnofseizedcannabis")]
        public IList<MicrosoftDynamicsCRMcsuApplicationforreturnofseizedcannabis> BusinessUnitCsuApplicationforreturnofseizedcannabis { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "business_unit_csu_seizeditemsrequestedforreturn")]
        public IList<MicrosoftDynamicsCRMcsuSeizeditemsrequestedforreturn> BusinessUnitCsuSeizeditemsrequestedforreturn { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "business_unit_csu_judicialreview")]
        public IList<MicrosoftDynamicsCRMcsuJudicialreview> BusinessUnitCsuJudicialreview { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "business_unit_csu_courtdate")]
        public IList<MicrosoftDynamicsCRMcsuCourtdate> BusinessUnitCsuCourtdate { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "business_unit_csu_phonehistory")]
        public IList<MicrosoftDynamicsCRMcsuPhonehistory> BusinessUnitCsuPhonehistory { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "business_unit_csu_addresshistory")]
        public IList<MicrosoftDynamicsCRMcsuAddresshistory> BusinessUnitCsuAddresshistory { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "business_unit_csu_vehicledetail")]
        public IList<MicrosoftDynamicsCRMcsuVehicledetail> BusinessUnitCsuVehicledetail { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "business_unit_csu_casevehicledetail")]
        public IList<MicrosoftDynamicsCRMcsuCasevehicledetail> BusinessUnitCsuCasevehicledetail { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "business_unit_csu_complaintseizure")]
        public IList<MicrosoftDynamicsCRMcsuComplaintseizure> BusinessUnitCsuComplaintseizure { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "business_unit_csu_csaactivity")]
        public IList<MicrosoftDynamicsCRMcsuCsaactivity> BusinessUnitCsuCsaactivity { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "business_unit_csu_csaspecifiedactivity")]
        public IList<MicrosoftDynamicsCRMcsuCsaspecifiedactivity> BusinessUnitCsuCsaspecifiedactivity { get; set; }
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "business_unit_csu_caseseizedtypesandamounts")]
        public IList<MicrosoftDynamicsCRMcsuCaseseizedtypesandamounts> BusinessUnitCsuCaseseizedtypesandamounts { get; set; }
