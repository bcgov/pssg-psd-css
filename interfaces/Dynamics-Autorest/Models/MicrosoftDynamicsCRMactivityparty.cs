...
namespace Gov.Jag.Pssg.Csa.Interfaces.Models
{
    ...
    public partial class MicrosoftDynamicsCRMactivityparty
    {
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "partyid_csu_complaints")]
        public MicrosoftDynamicsCRMcsuComplaints PartyidCsuComplaints { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "partyid_csu_subjectofcomplaint")]
        public MicrosoftDynamicsCRMcsuSubjectofcomplaint PartyidCsuSubjectofcomplaint { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "activityid_csu_casetask_activityparty")]
        public MicrosoftDynamicsCRMcsuCasetask ActivityidCsuCasetaskActivityparty { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "partyid_csu_vehicledetail")]
        public MicrosoftDynamicsCRMcsuVehicledetail PartyidCsuVehicledetail { get; set; }
